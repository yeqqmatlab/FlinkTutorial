...
//        DataStream<String> inputDataStream = env.readTextFile(inputPath);
        ...
        String host = ConfigurationManager.getProperty(Constants.SOCKET_HOST);
        String port = ConfigurationManager.getProperty(Constants.SOCKET_PORT);
...
/*        ParameterTool parameterTool = ParameterTool.fromArgs(args);
        ...
        // 从socket文本流读取数据
        DataStream<String> inputDataStream = env.socketTextStream(host, Integer.parseInt(port));
